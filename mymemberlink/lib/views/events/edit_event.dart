...
class _EditEventScreenState extends State<EditEventScreen> {
  ...
  void initState() {
    ...
    startDateTime = 
      formatter.format(DateTime.parse(widget.myevent.eventStartdate.toString()));
    endDateTime = 
      formatter.format(DateTime.parse(widget.myevent.eventEnddate.toString()));
  }
                    ...
                    GestureDetector(
                      ...
                      onTap: (){
                        showDatePicker(
                          ...
                          lastDate: DateTime(2030)).then((selectedDate){
                            if (selectedDate != null){
                              showTimePicker(
                                context: context, 
                                initialTime: TimeOfDay.now()).then((selectTime){
                                  if(selectTime != null){
