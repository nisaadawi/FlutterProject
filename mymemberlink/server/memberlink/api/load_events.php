<?php
    ...
    $sqlloadevent = "SELECT *  FROM `tbl_events` ORDER BY `event_date` DESC";
    $result = $conn->query($sqlloadevent);
    $number_of_result = $result->num_rows;

    $number_of_page = ceil($number_of_result / $results_per_page);
    $sqlloadevent = $sqlloadevent." LIMIT $page_first_result, $results_per_page";
